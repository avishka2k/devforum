  ...
  const handleDelete = () => {
    try {
      axios
        ...
        .catch((error) => {
          console.log(error);
          Notification({ message: 'An error occurred while deleting the post', type: 'error' });
        });
            ...
            <div className="-mx-3 flex flex-wrap gap-y-4">
              ...
              <div className="w-full px-3 2xsm:w-1/2">
                <button
                  ...
                  className="block w-full rounded border p-3 text-center font-medium text-white transition hover:bg-opacity-90 bg-meta-1"
                >
                  Delete Post
                </button>
              </div>
