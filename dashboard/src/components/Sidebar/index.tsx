        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/tags"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('tags') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Backup & Security --> */}
              <li>
                <NavLink
                  to="/backup-security"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('backup-security') &&
                    'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
          ...
          <div className="ml-4">
            <a href="https://www.digitalocean.com/?refcode=2859d543cb19&utm_campaign=Referral_Invite&utm_medium=Referral_Program&utm_source=badge">
              <img
