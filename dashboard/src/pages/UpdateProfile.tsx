  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const response = await axios.put(
        `${import.meta.env.VITE_API_ENDPOINT}/user/${userData.id}/profile`,
        formData,
        {
          headers: {
                ...
                <div className="p-7">
                  <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                    ...
                    <div className="w-full sm:w-1/2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          className="w-full rounded border border-stroke bg-gray-2 py-3 pl-11.5 pr-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                          type="text"
                          id="username"
                          placeholder="abcd123"
                          value={username}
                  ...
                  <div className="w-full mb-5.5">
                    ...
                    <input
                      ...
                      name="headline"
                      id="headline"
                      placeholder="Ex: Web Developer at Company"
                      value={headline}
